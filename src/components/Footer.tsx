...
export default function Footer() {
  return (
    <footer className="flex flex-col gap-[32px] md:gap-[40px] px-[20px] md:px-[120px] py-[40px] md:py-[60px] bg-[#4A6CF7]">
      <div className="flex flex-col md:flex-row gap-[32px] md:gap-[60px]">
        <div className="flex flex-col gap-[16px] flex-1">
          <span className="text-[22px] md:text-[24px] font-bold text-white">Talentify</span>
